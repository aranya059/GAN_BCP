...
parser.add_argument('--self_max_iteration', type=int,  default=25000, help='maximum self-train iteration to train')
parser.add_argument('--max_samples', type=int,  default=28, help='maximum samples to train')
